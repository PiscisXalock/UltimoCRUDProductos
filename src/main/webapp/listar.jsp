...
<html>
    <%
        ...
        if (usuarioLogeado == null) {
            String mensaje = "Debe loguearse primero para acceder aquí. Los niños malos serán castigados.";
    ...
    <body>
        ...
        <div  id="lista">
            ...
            <% List<Productos> misProductos = (List<Productos>) request.getAttribute("misProductos");
                double num_paginas = (double) request.getAttribute("num_paginas");
                Math.floor(num_paginas);
                int pagina = (int) request.getAttribute("pagina");
            %>
            <span> <strong><span style="color: blue">${pagina}</span>/ <%=Math.floor(num_paginas)%></strong></span>
