    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String op = request.getParameter("op");
            ...
            if ( op.equals("listar")){
                ...
                double num_paginas = Math.floor(Math.ceil(misProductos.size() / NUM_LINEAS_PAGINAS));
                misProductos = ProductosCRUD.getProductosPaginados(offset, NUM_LINEAS_PAGINAS);
